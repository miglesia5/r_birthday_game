...
class Game {
  ...
  drawIntro(ctx) {
    ...
    ctx.fillText(`Regi's Birthday SPACE BASH`, 110, 150);

    ctx.fillStyle = 'red';
    ctx.font = 'bold 48px Russo One';
    ctx.fillText(`
     Feliz Cumple Regi sabes que te quiero mil, pasala lindo destruyendo un poco las cosas que no te gustan tambien ---Algunos niveles son mios sorry no los pude evitar =p :*---- 
    HIT ENTER TO START`, 50, 300);
